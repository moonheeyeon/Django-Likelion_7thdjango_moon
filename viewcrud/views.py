...
def signup(request):
    if request.method == 'POST':
        if request.POST['password1'] == request.POST['password2']:
            ...
            return redirect('home')
    return render(request, 'viewcrud/signup.html')
...
def login(request):
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            return render(request, 'viewcrud/login.html', {'error': 'username or password is incorrect.'})
    else:
        return render(request, 'viewcrud/login.html')
...
def read(request):
    ...
    return render(request, 'viewcrud/viewcrud.html', {'blogs':blogs, 'posts':posts})
...
def detail(request, pk):
    ...
    if request.method == "POST":
        ...
        form = CommentForm()
    return render(request, 'viewcrud/detail.html', {'blog': blog_detail, 'form': form})
